                ...
                Steps=[{
                    ...
                    'HadoopJarStep': {
                        ...
                        'Args': ['spark-submit',
                                 ...
                                 '--master', 'yarn',
                                 '--deploy-mode', 'cluster',
                                 's3://datalake-eder-igti-edc-tf-prod-086556745643/emr-code/pyspark/01_delta_spark_insert.py'
                                 ]
                    }
                },
                {
                    ...
                    'HadoopJarStep': {
                        ...
                        'Args': ['spark-submit',
                                 ...
                                 '--master', 'yarn',
                                 '--deploy-mode', 'cluster',
                                 's3://datalake-eder-igti-edc-tf-prod-086556745643/emr-code/pyspark/02_delta_spark_upsert.py'
                                 ]
                    }
                }],
            )
