    ...
    def emr_process_enem_data():
        cluster_id = client.run_job_flow(
            ...
            Instances={
                ...
                'Ec2KeyName': 'eder-igti-ec2-key',
                'KeepJobFlowAliveWhenNoSteps': True,
                'TerminationProtected': False,
                'Ec2SubnetId': 'subnet-06066a0e1bb27fbd9'
            },
            ...
            Steps=[{
                ...
                'HadoopJarStep': {
                    ...
                    'Args': ['spark-submit',
                            ...
                            '--master', 'yarn',
                            '--deploy-mode', 'cluster',
                            's3://datalake-eder-igti-edc-tf-prod-086556745643/emr-code/pyspark/job_spark/01_delta_spark_insert.py'
                        ]
                }
            }],
        )
                ...
                Steps=[{
                    ...
                    'HadoopJarStep': {
                        ...
                        'Args': ['spark-submit',
                                ...
                                '--master', 'yarn',
                                '--deploy-mode', 'cluster',
                                's3://datalake-eder-igti-edc-tf-prod-086556745643/emr-code/pyspark/job_spark/02_delta_spark_upsert.py'
                            ]
                    }
                }]
            )
